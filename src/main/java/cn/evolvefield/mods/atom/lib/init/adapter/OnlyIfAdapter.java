    ...
    public static boolean checkCondition(OnlyIf onlyIf, String source, String type, Object objInQuestion, ResourceLocation objId) {
        ...
        if (onlyIf != null) {
            ...
            try {
                ...
                AtomLib.LOG.warn("Failed to parse @OnlyIf({}) in {}! {} will" + (onlyIf.invert() ? " not be registered due to inversion." : " be registered anyway."), JSONObject.quote(member), source, type);
            }
